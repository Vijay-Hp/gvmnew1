  ...
  const handleSubmit = (event) => {
    ...
    if (form.checkValidity() === false) {
      ...
      const newData = {
        ...
        mobile_no: purchaseData.mobile_number,
        ...
        user_type: storedEmail === "vijayvebbox@gmail.com" ? "admin" : "user",
      };
...
export default Add_purchase_vehicle;
