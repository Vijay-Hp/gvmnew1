...
export const UserDashboardContent = (props) => {
  return (
    <>
...
export const UserTableContent = ({ data }) => {
...
export const UserTableContent1 = ({ data }) => {
...
export const UserTableContent2 = ({ data }) => {
  const tableHeadStyle = {
    backgroundColor: "#3d3b52",
    color: "white",
    padding: "10px",
...
export const UserTableContent3 = ({ data }) => {
  const tableHeadStyle = {
    backgroundColor: "#3d3b52",
    color: "white",
    padding: "10px",
...
export const UserTableContent4 = ({ data }) => {
  const tableHeadStyle = {
    backgroundColor: "#3d3b52",
    color: "white",
    padding: "10px",
