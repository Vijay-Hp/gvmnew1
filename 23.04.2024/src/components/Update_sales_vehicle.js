              ...
              <Form noValidate validated={validated} onSubmit={handleSubmit}>
                ...
                >
                  ...
                  <Id
                    name=" Chassic No"
                    handleDataChange={handleDataChange}
                    textboxName="chassic_no"
                    value={purchaseData?.chassic_no}
                  />
                  <Id
                    name=" RC Book No"
                    handleDataChange={handleDataChange}
                    textboxName="rcbook_no"
                    value={purchaseData?.rcbook_no}
                  />
                  <No
                    name="Product Quantity"
                    handleDataChange={handleDataChange}
                    textboxName="product_quantity1"
                    value={purchaseData?.product_quantity1}
                  />
                  <Nopoint
                    name="Fuel Liter"
                    handleDataChange={handleDataChange}
...
export default Update_sales_vehicle;
