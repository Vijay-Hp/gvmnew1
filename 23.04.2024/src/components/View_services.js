...
function View_service() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        "https://vebbox.in/gvmbackend/controllers/api/get/viewService.php"
      );
  ...
  const deleteData = async () => {
    ...
    await axios
      .post(
        "https://vebbox.in/gvmbackend/controllers/api/delete/serviceDelete.php",
        payload
      )
      .then((res) => {
            ...
            <div style={{ overflowX: "auto", maxWidth: "100%" }}>
              <Table bordered className="table-center">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th onClick={() => handleSort("vehicle_no")}>
                      vehicle_no {getSortArrow("vehicle_no")}
                    </th>
                    <th>date</th>
