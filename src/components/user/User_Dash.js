...
import {
  ...
  UserTableContent1,
  UserTableContent2,
} from "./UserDashboard_content.js";
import {
  TableContent,
  TableContent3,
  TableContent4,
} from "../Dashboard_content.js";
          ...
          <Row>
            <Col xs={12} md={8} lg={4} className="mb-3">
              <NavLink to="/user_rentalproducts" className="ul">
                <UserDashboardContent title="Products" img={Rental} />
              </NavLink>
            </Col>

            <Col xs={12} md={8} lg={4} className="mb-3">
              <NavLink to="/user_generalentry" className="ul">
                <UserDashboardContent title="General Entry" img={General} />
              </NavLink>
            </Col>
          ...
          <Row className="g-3" style={{ justifyContent: "space-evenly" }}>
            ...
            >
              ...
              >
                ...
                <UserTableContent1 data={purchaseData1} />
                <NavLink to="/user_viewconstructions">
                  <div style={{ display: "flex", justifyContent: "right" }}>
                    <ArrowForwardIcon style={{ color: "black" }} />
                  </div>
                </NavLink>
            ...
            >
              ...
              >
                ...
                <UserTableContent2 data={purchaseData2} />
                <NavLink to="/user_rentalviewproducts">
                  <div style={{ display: "flex", justifyContent: "right" }}>
                    <ArrowForwardIcon style={{ color: "black" }} />
                  </div>
                </NavLink>
