...
function UserUpdate_purchase_payment() {
        ...
        <Container fluid>
          <Row>
            ...
            <Col xs={12} md={8} lg={4} className="d-grid gap-2 mt-5">
              <NavLink to="/user_updatepurchase" className="ul">
            ...
            <Col xs={12} md={8} lg={4} className="d-grid gap-2 mt-5">
              <NavLink to="/userupdate_purchase_payment" className="ul">
            ...
            <Col xs={12} md={8} lg={4} className="d-grid gap-2 mt-5">
              <NavLink to="/userupdate_purchase_vehicle" className="ul">
                <Button size="lg" style={buttonStyle} >
                  Vehicle
                </Button>
              </NavLink>
...
export default UserUpdate_purchase_payment;